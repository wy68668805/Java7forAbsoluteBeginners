...
public class AverageTest {
	public static void main(String[] args) {
		...
		String testString = buildTestString(averageImpl.getInts(),averageImpl.getAverage(),averageImpl.getRunTime());
		...
		testString = buildTestString(averageImpl.getInts(),averageImpl.getAverage(),averageImpl.getRunTime());
